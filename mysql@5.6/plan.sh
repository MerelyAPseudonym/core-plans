...
pkg_license=('GPL-2.0')
pkg_source=http://dev.mysql.com/get/Downloads/MySQL-5.6/${pkg_name}-${pkg_version}.tar.gz
# https://dev.mysql.com/downloads/file/?id=474438
...
do_build() {
  cmake . \
          ## -DLOCAL_BOOST_DIR="$(pkg_path_for core/boost159)" \
